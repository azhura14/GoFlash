...
/**
 * Created by PSB-BROO on 10/26/2017.
 */

public class RobotoTextViewExpand extends TextView  {
    ...
    public RobotoTextViewExpand(Context context) {
        super(context);
        if (isInEditMode()) return;
        parseAttributes(null);
    }

    public RobotoTextViewExpand(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) return;
    ...
    public void setOnClickListenerExpand() {
        trim = !trim;
        setText();
        requestFocusFromTouch();
    }

    public RobotoTextViewExpand(Context context, AttributeSet attrs, int defStyle) {
